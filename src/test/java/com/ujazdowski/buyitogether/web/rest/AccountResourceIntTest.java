...
import com.ujazdowski.buyitogether.config.Constants;
import com.ujazdowski.buyitogether.domain.Authority;
import com.ujazdowski.buyitogether.domain.User;
import com.ujazdowski.buyitogether.repository.AuthorityRepository;
import com.ujazdowski.buyitogether.repository.UserRepository;
import com.ujazdowski.buyitogether.security.AuthoritiesConstants;
import com.ujazdowski.buyitogether.service.MailService;
import com.ujazdowski.buyitogether.service.UserService;
import com.ujazdowski.buyitogether.service.dto.PasswordChangeDTO;
import com.ujazdowski.buyitogether.service.dto.UserDTO;
import com.ujazdowski.buyitogether.web.rest.errors.ExceptionTranslator;
import com.ujazdowski.buyitogether.web.rest.vm.KeyAndPasswordVM;
import com.ujazdowski.buyitogether.web.rest.vm.ManagedUserVM;
import com.ujazdowski.buyitogether.web.rest.vm.RegisterVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setEmail("valid.email@example.com");// <-- invalid
...
//    }
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        // First user
        RegisterVM firstUser = new RegisterVM();
        firstUser.setPassword("password");
        firstUser.setEmail("email@example.com");// <-- invalid
        ...
        RegisterVM secondUser = new RegisterVM();
        ...
        RegisterVM userWithUpperCaseEmail = new RegisterVM();
        firstUser.setPassword("password1");
        firstUser.setEmail("EMAIL@EXAMPLE.COM");// <-- invalid
